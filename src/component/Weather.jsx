...
const Weather = () => {
  ...
  return (
    <div>
        <motion.div initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{ duration: 1 }} className="w-full mx-auto sm:w-2/3 sm:mt-5 mt-12 flex flex-col items-center justify-center py-5 sm:px-10 px-5 bg-[#500ea4]">
